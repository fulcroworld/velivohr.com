      ...
      >
        <div className="wrap nav">
          <Link to="/" className="brand">
            <img src="/assets/VelioHRlogo.png" className="logo-dark" alt="VelivoHR" />
            <img src="/assets/VelioHRlogoW.png" className="logo-white" alt="VelivoHR" />
          </Link>
          ...
          <Link to="/contact" className="nav-cta">Start a Conversation</Link>
          <button
            className="menu-btn"
            aria-label="Menu"
