  ...
  '@graph': [
    breadcrumb([{ name: 'Services', path: '/services/' }]),
    {
      ...
      hasOfferCatalog: {
        ...
        itemListElement: [
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Sourcing & Screening', description: 'Structured candidate identification and preliminary screening for marcom roles.' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Background Verification', description: 'Preliminary background verification checks, available on request.' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Interview Coordination', description: 'End-to-end scheduling, logistics, and feedback management.' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Offer Management', description: 'Salary negotiation support, offer rollout, and closing.' } },
        ],
      },
    },
  ],
...
export const processSchema = {
  ...
  '@graph': [
    breadcrumb([{ name: 'How We Work', path: '/process/' }]),
    {
      ...
      provider: { '@id': ORG_ID },
      step: [
        { '@type': 'HowToStep', position: '1', name: 'Intake & Setup', text: 'Confirm the Statement of Work, finalize the job description, salary bands, and evaluation rubric.' },
        { '@type': 'HowToStep', position: '2', name: 'Sourcing', text: 'Structured candidate identification and scoring; first shortlist delivered in under an hour for active roles.' },
        { '@type': 'HowToStep', position: '3', name: 'Interviews', text: 'End-to-end interview scheduling, assessment coordination, and structured feedback collection.' },
        { '@type': 'HowToStep', position: '4', name: 'Offer Management', text: 'Negotiation support through offer rollout to final acceptance.' },
        { '@type': 'HowToStep', position: '5', name: 'Pre-joining Engagement', text: 'Candidate engagement and onboarding support to ensure smooth joining.' },
      ],
    },
  ],
}
      ...
      offers: [
        {
          ...
          description: 'Recruitment fee for roles with Gross Annual CTC up to INR 6 Lakhs.',
          priceSpecification: { '@type': 'UnitPriceSpecification', price: '5', priceCurrency: 'INR', unitText: '% of Gross Annual CTC' },
          eligibleRegion: 'IN',
        },
        {
          '@type': 'Offer',
          name: 'Mid-Level Placement',
          description: 'Recruitment fee for roles with Gross Annual CTC between INR 6–18 Lakhs.',
          priceSpecification: { '@type': 'UnitPriceSpecification', price: '5', priceCurrency: 'INR', unitText: '% of Gross Annual CTC' },
          eligibleRegion: 'IN',
        },
        {
          ...
          description: 'Recruitment fee for roles with Gross Annual CTC above INR 18 Lakhs.',
          priceSpecification: { '@type': 'UnitPriceSpecification', price: '8.33', priceCurrency: 'INR', unitText: '% of Gross Annual CTC' },
          eligibleRegion: 'IN',
        },
      ],
    },
...
export const contactSchema = {
  ...
  '@graph': [
    breadcrumb([{ name: 'Contact', path: '/contact/' }]),
    {
      ...
      description: 'Get in touch with VelivoHR to discuss your next marcom industry hire.',
      mainEntity: {
        '@id': ORG_ID,
        contactPoint: {
          '@type': 'ContactPoint',
